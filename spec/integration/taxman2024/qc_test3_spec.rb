...
RSpec.describe Taxman2024::Calculate do
  ...
  let(:p) do
    Taxman2024::PeriodInput.new(
      ...
      qc_taxable_periodic_income: 5_000,
      qc_taxable_non_periodic_income: 20_000,
      province: "qc",
  ...
  let(:c) do
    Taxman2024::PensionInput.new(
      ...
      qc_pensionable_income_this_period: 25_000,
      qc_pensionable_non_periodic_income_this_period: 20_000,
