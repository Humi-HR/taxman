...
RSpec.describe Taxman2024::Calculate do
  ...
  let(:c) do
    Taxman2024::PensionInput.new(
      pensionable_income_this_period: 1_077.31,
  ...
  let(:e) do
    Taxman2024::EiInput.new(
      insurable_income_this_period: 1_077.31,
  ...
  it "matches PDOC's CPP deduction" do
    expect(calculate[:employee_cpp_contribution]).to be_within(0.1).of 60.10
  end

  it "matches PDOC's EI calculation" do
    expect(calculate[:employee_ei_contribution]).to eq 17.88
  end
end
