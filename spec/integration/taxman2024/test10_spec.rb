...
RSpec.describe Taxman2024::Calculate do
  ...
  let(:p) do
    Taxman2024::PeriodInput.new(
      taxable_periodic_income: 11_000,
  ...
  let(:t) do
    Taxman2024::PersonalTaxDeductionsInput.new(
      ...
      provincial_personal_amount: 17_373,
  ...
  it "matches PDOC's federal tax" do
    expect(calculate[:federal_tax]).to eq 2_572.51
  end

  it "matches PDOC's provincial tax" do
    expect(calculate[:provincial_tax]).to eq 1_186.66
  end
