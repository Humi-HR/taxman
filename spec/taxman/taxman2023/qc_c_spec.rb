...
RSpec.describe Taxman2023::QcC do
  ...
  context "when the employee will meet and exceed the maximum this period" do
    let(:qc_a5) { Taxman2023::Qpp::MAX - 100_00 }
    let(:qc_s3) { 4_000_00 }
  ...
  context "with a $5.5k salary monthly and max CPP contributions less $100" do
    let(:qc_a5) { 0 }
    let(:qc_s3) { 5_500_00 }
    let(:qc_r) { Taxman2023::Cpp::MAX - 100_00 }
