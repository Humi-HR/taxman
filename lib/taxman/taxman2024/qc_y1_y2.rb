...
module Taxman2024
  ...
  class QcY1Y2 < Factor
    ...
    def qc_t
      Taxman2024::QcY::RATES_AND_CONSTANTS[bracket][0]
    end

    def qc_k
      Taxman2024::QcY::RATES_AND_CONSTANTS[bracket][1]
    end

    private

    def bracket
      @bracket ||= Taxman2024::QcY::RATES_AND_CONSTANTS.keys.sort.find do |bracket|
